...
export enum MenuLocationEnum {
  ...
  /** Put the menu in the footer_menu_RRSS location */
  FooterMenuRrss = 'FOOTER_MENU_RRSS',
  /** Put the menu in the top_menu location */
  TopMenu = 'TOP_MENU'
}
...
/** The template assigned to the node */
export type Template_Blog = ContentTemplate & {
...
/** The template assigned to the node */
export type Template_Inicio = ContentTemplate & {
  __typename?: 'Template_Inicio';
  /** The name of the template */
  templateName?: Maybe<Scalars['String']['output']>;
};

/** The template assigned to the node */
export type Template_InicioProvisional = ContentTemplate & {
  __typename?: 'Template_InicioProvisional';
  /** The name of the template */
  templateName?: Maybe<Scalars['String']['output']>;
};

/** The template assigned to the node */
export type Template_PginaDeContacto = ContentTemplate & {
  __typename?: 'Template_PginaDeContacto';
  /** The name of the template */
  templateName?: Maybe<Scalars['String']['output']>;
};

/** The template assigned to the node */
export type Template_PginaDeIe = ContentTemplate & {
  __typename?: 'Template_PginaDeIE';
  /** The name of the template */
  templateName?: Maybe<Scalars['String']['output']>;
};

/** The template assigned to the node */
export type Template_PginaDeTesteos = ContentTemplate & {
  __typename?: 'Template_PginaDeTesteos';
  /** The name of the template */
  templateName?: Maybe<Scalars['String']['output']>;
};

/** The template assigned to the node */
export type Template_SobreM = ContentTemplate & {
  __typename?: 'Template_SobreM';
  /** The name of the template */
  templateName?: Maybe<Scalars['String']['output']>;
};
